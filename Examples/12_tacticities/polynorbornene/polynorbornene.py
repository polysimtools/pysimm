...
def run(test=False):
    ...
    # run the polymer random walk tacticity method with 50 total repeat units with minimizations and error checking (when a hardcore overlap is found, the last inserted monomer shrunken and gradually re-expanded)
...
# prefix: prefix for output files
    ...
    polymer = random_walk_tacticity(A, n, forcefield=f,capped=True,tacticity='syndiotactic',rotation=180,error_check=False,sim=0)
